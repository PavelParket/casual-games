...
@Component
public class MahjongTransactionFactory implements GameTransactionFactory<MahjongTransactionRequest> {
    ...
    @Override
    public List<Transaction> createTransactions(MahjongTransactionRequest request) {
    ...
    private Transaction buildTransaction(UUID roomId, RoomType roomType, PlayerBetMessage bet,
