...
--precondition-sql-check expectedResult:0 SELECT COUNT(*) FROM pg_indexes WHERE table_name = 'transactional_outbox_kafka_messages' AND index_name = 'idx_outbox_unsent'
